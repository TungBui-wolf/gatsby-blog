---
title: U-Net Kiến trúc mạnh mẽ cho Segmentation
date: 2020-01-15
description:
tags:
  - Image Processing
  - Deep Learning
banner: https://images.viblo.asia/9737595d-7758-46ba-a6c0-8213bdb6d891.png
---
...
* ##### Image Segmentation
Tiếp tục nâng cao hơn (Con người luôn có khát khao chinh phục mà :smile:). Chúng ta không muốn xác định vật thể chỉ bằng "bounding box" nữa, cần có một lớp viền tốt hơn để bao sát vào vật thể. Tác vụ này được gọi với một cái tên: Segmentation (dịch ra là Phân đoạn hình ảnh thì phải)
...
Trước khi bắt đầu vào phần chính của bài viết này (kiến trúc U-net), có lẽ mình nên lan man một chút bên ngoài về các kiến trúc Deep Learnin
...
Không làm gì cả! Có thể bạn sẽ làm mọi chuyện tệ hơn. (Just Kidding :smile:)
Tuy nhiên, bạn có thể sử dụng U-net, và tiến hành "dạy" máy tính cách xác định các cấu trúc đó. 
Cùng thử nào !!!!!
Muốn "dạy" máy tính thì cần có kiến thức, kiến thức ở đây là dataset. Các bạn có thể lấy dataset từ link sau: [dataset](https://www.kaggle.com/c/ultrasound-nerve-segmentation/data)
...
Một số chú ý:
Hàm loss được định nghĩa ở đây là hàm Dice_loss (Các bạn có thể tham khảo thêm các hàm loss khác tại [đây](https://lars76.github.io/neural-networks/object-detection/losses-for-segmentation/))
